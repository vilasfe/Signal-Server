...
class Input {
public:
    static auto LoadSDF(std::string_view name) -> int;
...
private:
    static auto LoadSDF_SDF(std::string_view name) -> int;
    static auto LoadSDF_GZ(std::string_view name) -> int;
    static auto LoadSDF_BZ(std::string_view name) -> int;
    static auto BZfgets(char *output, BZFILE *bzfd, unsigned length) -> char*;
    static auto GZfgets(char *output, gzFile gzfd, unsigned length) -> char*;
    static int bzerror;
    static int gzerr;
